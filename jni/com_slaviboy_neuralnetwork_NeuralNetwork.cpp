#ifndef _Included_com_slaviboy_neuralnetwork_NeuralNetwork_CPP
#define _Included_com_slaviboy_neuralnetwork_NeuralNetwork_CPP

#include <iostream>
#include "com_slaviboy_neuralnetwork_NeuralNetwork.h"
#include "NeuralNet.h"
#include "Handle.h"

JNIEXPORT void JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_init(JNIEnv *env, jobject obj, jdouble learning_rate,
                                                               jint input_nodes, jint hidden_nodes, jint output_nodes) {
    NeuralNet *net = new NeuralNet(learning_rate, (unsigned) input_nodes, (unsigned) hidden_nodes, (unsigned) output_nodes);
    set_handle<NeuralNet>(env, obj, net);
}

JNIEXPORT void JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_dispose(JNIEnv *env, jobject obj) {
    NeuralNet *net = get_handle<NeuralNet>(env, obj);
    // Deallocate NeuralNet
    delete net;
}

JNIEXPORT jdoubleArray JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_query(JNIEnv *env, jobject obj, jdoubleArray jinputs_array) {
...
JNIEXPORT void JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_train(JNIEnv *env, jobject obj, jdoubleArray jinputs_array, jdoubleArray jtargets_array) {
...
JNIEXPORT void JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_setWih(JNIEnv *env , jobject obj, jobjectArray jwih) {
...
JNIEXPORT void JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_setWho(JNIEnv *env, jobject obj, jobjectArray jwho) {
...
JNIEXPORT jobjectArray JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_getWih(JNIEnv *env, jobject obj) {
...
JNIEXPORT jobjectArray JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_getWho(JNIEnv *env, jobject obj) {
...
JNIEXPORT jdouble JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_getLearningRate(JNIEnv *env, jobject obj) {
    NeuralNet *net = get_handle<NeuralNet>(env, obj);
    return net->get_learning_rate();
}


JNIEXPORT jint JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_getInputNodes(JNIEnv *env, jobject obj) {
    NeuralNet *net = get_handle<NeuralNet>(env, obj);
    return (int)net->get_input_nodes();
}


JNIEXPORT jint JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_getHiddenNodes(JNIEnv *env, jobject obj) {
    NeuralNet *net = get_handle<NeuralNet>(env, obj);
    return (int)net->get_hidden_nodes();
}


JNIEXPORT jint JNICALL Java_com_slaviboy_neuralnetwork_NeuralNetwork_getOutputNodes(JNIEnv *env, jobject obj) {
    NeuralNet *net = get_handle<NeuralNet>(env, obj);
